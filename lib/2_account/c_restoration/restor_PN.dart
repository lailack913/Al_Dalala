        ...
        SafeArea(
          ...
          Container(
            ...
            Column(
              ...
              children: [
                Text("إٍسترجاع الحساب",
                  style: TextStyle( fontSize: 31,  ),) ,
                Text("يرجى ادخال رقم الهاتف لاسترجاع الحساب",
                ...
                Text("سيتم ارسال رمز تاكيد الى رقم الهاتف المدخل لاسترجاع الحساب لذا يرجى التأكد من كتابته بشكل صحيح",
